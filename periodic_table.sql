...
INSERT INTO public.properties VALUES (4, 9.0122, 1287, 2478, 2);
...
--
-- Name: elements unique_element_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_element_name UNIQUE (name);
